  ...
  render() {
    return (
      <ScrollView style={[styles.container]}>
        ...
        <Text style={styles.text}>A: para,独立开发者</Text>
        <Text style={styles.text}>Q: 该APP使用的场景是什么?</Text>
        <Text style={styles.text}>A: 当身处陌生环境,又出现内急的情况,可使用该APP找到附近的厕所.</Text>
        ...
        <Text style={styles.text}>A: 如有其他问题,可发送邮件到paraofheaven@foxmail.com</Text>
        <Text style={styles.text}>......</Text>
      </ScrollView>
    );
  }
